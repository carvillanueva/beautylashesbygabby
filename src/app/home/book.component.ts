...
@Component({
  ...
  template: `
    ...
    <div class="container col-xs-12 mb-5 after-banner-fix">
      ...
      <iframe src="https://app.squarespacescheduling.com/schedule.php?owner=24678638" title="Schedule Appointment" width="100%" height="800" frameBorder="0"></iframe><script src="https://embed.acuityscheduling.com/js/embed.js" type="text/javascript"></script>
    </div>
  `
})
